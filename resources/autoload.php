...
It is also possible to add other functionality to this file that is not necessarily a function 
definition. This will make sure that the Index gateway and Handlers themselves are not touched 
during project development for the same purpose.
